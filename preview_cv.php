...
$id=$_SESSION['sid'];
//echo $id;
//echo "select * from bio_cv where s_id=$id order by cv_id desc limit 1";
$r=mysqli_fetch_array(mysqli_query($cn,"select * from bio_cv where s_id=$id order by cv_id desc limit 1 "));
}
?>
                                ...
                                <div class="register-form-content">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 ml-auto">
                                            <div class="register-form-wrap">
                                                <div class="mainDetails">
                                                    <div id="headshot">
                                                        <img src="admin/image/cv_biodata/<?php echo $r[2]; ?>" alt="Alan Smith" style="width: 100px;height: 100px;"  />
                                                    </div>
                                                    
                                                    <div id="name">
                                                        <h1><?php echo $r[3]; ?></h1><br>
                                                        <h1><?php echo $r[7]; ?></h1>
                                                    </div>
                                                    
                                                    <div id="contactDetails">
                                                        <ul>
                                                            <li>Email: <?php echo $r[6]; ?></li>
                                                            <li>Mobile: <?php echo $r[5]; ?></li>
                                                        </ul>
                                                    </div>
                                                    <div class="clear"></div>
                                                </div>
                                                <div id="mainArea">
                                                            ...
                                                            <div class="sectionContent">
                                                                <table class="table">
                                                                    <tr>
                                                                        ...
                                                                        <td><label><?php echo $r[8]; ?></label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="font-weight: bold;">Date Of Birth:</th>
                                                                        <td><label><?php echo $r[11]; ?></label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="font-weight: bold;">Place Of Birth:</th>
                                                                        <td><label><?php echo $r[12]; ?></label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="font-weight: bold;">Gender:</th>
                                                                        <td><label><?php echo $r[9]; ?></label></td>
                                                                    </tr>
                                                                    
                                                                    <tr>
                                                                        <th style="font-weight: bold;">Maritial Status:</th>
                                                                        <td><label><?php echo $r[10]; ?></label></td>
                                                                    </tr>
                                                                    <tr>
                                                    ...
                                                    <section>
                                                        <article>
                                                            <div class="sectionTitle">
                                                                <h1>Additional Traning/Course</h1>
                                                            </div>
                                                            
                                                            <div class="sectionContent">
                                                                <table class="table">
                                                                    <tr>
                                                                        <th style="font-weight: bold;"><?php echo $r[29]; ?></th>
                                                                        <td><label><?php echo $r[30] ?></label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="font-weight: bold;"><?php echo $r[31]; ?></th>
                                                                        <td><label><?php echo $r[32] ?></label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="font-weight: bold;"><?php echo $r[33]; ?></th>
                                                                        <td><label><?php echo $r[34]; ?></label></td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                        </article>
                                        ...
                                        <form name="f1" method="post" enctype="multipart/form-data">
                                            <button type="button" class="btn btn-reg" onclick="location.href='pdf_cv.php?id=<?php echo $r[0]; ?>' "  >DOWNLOAD PDF</button>
                                        </form>
                                    </div>
                                </div>
                            </div>

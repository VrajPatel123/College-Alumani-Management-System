...
else
{
  ...
  if (isset($_POST['b1']))
  {
    ...
    { 
      $job_id=$checkbox[$i];
      mysqli_query($cn,"delete from job_addetail where job_id='".$job_id."' ");
    }
  ...
  include 'DBController.php';
    ...
    $productResult = $db_handle->runQuery("select * from job_ad");
...
require_once('connection.php');
$result=mysqli_query($cn,"select * from job_ad");
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">View All Placement Detail</h3>
            ...
            <div class="card-body table-responsive p-3">
              ...
              <table id="example1" class="table table-bordered table-hover table-head-fixed">
                ...
                <tbody>
                  ...
                  <td><a href="delete_placement.php?no=<?php echo $data['job_id']; ?>"><i class="fas fa-skull-crossbones"></i></td>
                </tr>
                <?php 
                  }
                ?>

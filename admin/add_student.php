    ...
    <!-- Main content -->
          ...
          <div class="col-md-11">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" name="add_staff" enctype="multipart/data">
                <div class="card-body">
                  ...
                  <div class="form-group"style="text-align: left">
                    ...
                    <input type="date" class="form-control" id="" name="txtpassout" placeholder="Enter Passout">
                  </div>
                  ...
                  <div class="form-group"style="text-align: left">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="txtactive" value="active" checked>
                        <label for="customCheckbox1" class="form-check-label">Active</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input class="form-check-input" type="checkbox" id="txtnonactive" value="nonactive">
                        <label for="customCheckbox1" class="form-check-label">NonActive</label>
                      </div>
                  </div>
                </div>
                <!-- /.card-body -->

...
else
{
  ...
  $sql=mysqli_query($cn,"SELECT * FROM `mail`");
  if (isset($_POST['b1']))
  {
    ...
    { 
      $mail_id=$checkbox[$i];
      mysqli_query($cn,"delete from mail where news_id='".$mail_id."' ");
    }
  ...
  include 'DBController.php';
    ...
    $productResult = $db_handle->runQuery("select * from mail");
...
require_once('connection.php');
$result=mysqli_query($cn,"select * from mail");
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">View All Email</h3>
            ...
            <div class="card-body table-responsive p-3">
              ...
              <table id="example1" class="table table-bordered table-hover table-head-fixed">
                ...
                <tbody>
                  ...
                  <td><a href="delete_mail.php?no=<?php echo $data[0]; ?>"><i class="fas fa-skull-crossbones"></i></td>
                </tr>

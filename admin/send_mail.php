...
//     {
//         $to=$r[5];
//         $mail->SetFrom("riteshporiya124@gmail.com");
    ...
    <!-- Main content -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" name="send_mail" enctype="multipart/form-data" onsubmit="return validation()">
                <div class="card-body">
                   <div class="form-group"style="text-align: left">
                    ...
                    <div class="form-group"style="text-align: left">
                       <label>Name</label>
                        <select class="custom-select" name="txtename" id="txtename">

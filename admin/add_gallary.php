...
else
{
  ...
  if(isset($_POST['b1'])){ 
    ...
    $targetDir = "image/gallary/gallary_images/"; 
    ...
    if(!empty($fileNames)){ 
        ...
        if(!empty($insertValuesSQL)){ 
            ...
            $insert = $cn->query("INSERT INTO gallery (heading,description,type,file_name, uploaded_on) VALUES $insertValuesSQL"); 
            if($insert){ 
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2"style="text-align: right;">
          <div class="col-sm-7">
            <h1>Gallary Detail</h1>
          </div>
          <div class="col-sm-5">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active"> Gallary Detail</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-11">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title" >Add Multiple images</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                  ...
                  <div class="form-group"style="text-align: left">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                         <input type="file" class="custom-file-input" id="txtphoto" name="files[]" multiple >

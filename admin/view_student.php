...
else
{
  ...
  if (isset($_POST['b1']))
  {
    ...
    { 
      $s_id=$checkbox[$i];
      mysqli_query($cn,"delete from student_profile where s_id='".$s_id."' ");
    }
  ...
  include 'DBController.php';
    ...
    $productResult = $db_handle->runQuery("select * from student_profile");
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">View All Student Detail</h3>
            ...
            <div class="card-body table-responsive p-3">
              ...
              <table id="example1" class=" table table-bordered table-hover table-head-fixed">
                ...
                <tr>
                  <th><label>Select All</label>
                      <label>
                        ...
                        <input type="checkbox" name="checkall" id="checkall" align="center">
                ...
                <tbody>
                  ...
                  <td><a href="delete_student.php?no=<?php echo $data[0]; ?>"><i class="fas fa-skull-crossbones"></i></td>
                </tr>

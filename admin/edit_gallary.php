...
else
{
  ...
  $sql=mysqli_query($cn,"SELECT * FROM `gallery`");
  $r="";
...
if (isset($_POST['b2']))
  {
    ...
    else
    {
      ...
      move_uploaded_file($tempname, "image/gallary/gallary_images/$photo");
    
    }

    $sql1=  mysqli_query($cn,"UPDATE `gallery` SET `file_name`='$photo' WHERE `g_id`= '$id' ");

  header('location:edit_gallary.php');
            ...
            <div class="card-body table-responsive p-2">
              ...
              <table id="example1" class="table table-bordered table-hover table-head-fixed">
                ...
                <tr>
                  ...
                  <td><img src="image/gallary/gallary_images/<?php echo $data['file_name'];?>" style="max-height: 150px;max-width: 120px;padding-left: 50px" ></td>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-body">
                <form role="form" method="post" name="edit_gallary" enctype="multipart/form-data" id="myCoolForm">
                <div class="card-body">
 ...
 <script type="text/javascript">
  ...
  function views(sid)
  {
   ...
   $.ajax({
     url: 'fetch.php',
     type: 'POST',
     data: {id:sid,pname:"edit_gallary"},
     success:function(data){
      var d = jQuery.parseJSON(data);
      document.getElementById("txtid").value=d.g_id;
      document.getElementById("h1").value=d.file_name;
     }
   })

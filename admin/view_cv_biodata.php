...
else
{
  ...
  $sql=mysqli_query($cn,"SELECT student_profile.s_name,student_profile.surname,bio_cv.user_image,bio_cv.name,bio_cv.address,bio_cv.mobile,bio_cv.email,bio_cv.apply_for,bio_cv.nationality,bio_cv.gender,bio_cv.marital_status, bio_cv.dob,bio_cv.place_of_birth,bio_cv.year_ssc,bio_cv.year_hsc,bio_cv.year_graduate,bio_cv.year_pg,bio_cv.pg,bio_cv.graduation,bio_cv.hsc,bio_cv.ssc, bio_cv.subject_ssc,bio_cv.subject_hsc,bio_cv.subject_graduate,bio_cv.subject_pg,bio_cv.ssc_school,bio_cv.subject_hsc,bio_cv.subject_graduate,bio_cv.subject_pg, bio_cv.ssc_school,bio_cv.hsc_school,bio_cv.graduate_university,bio_cv.pg_university,bio_cv.add01_year,bio_cv.add01_info,bio_cv.add02_year,bio_cv.add02_info, bio_cv.add03_year,bio_cv.add03_info from bio_cv INNER JOIN student_profile ON bio_cv.s_id = student_profile.s_id");
    //$sql=mysqli_query($cn,"SELECT * FROM bio_cv");


  include 'DBController.php';
    $db_handle = new DBController();
    $productResult = $db_handle->runQuery("select * from bio_cv");
...
require_once('connection.php');
$result=mysqli_query($cn,"select * from cv");
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">View All CV Biodata</h3>
            ...
            <div class="card-body table-responsive p-3">
              ...
              <table id="example1" class="table table-bordered table-hover table-head-fixed">
                ...
                <tr>
                   ...
                   <td><img src="image/cv_biodata/<?php echo $data[2];?>" style="max-height: 150px;max-width: 120px;padding-left: 50px" ></td>

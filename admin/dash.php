...
<!-- user profile -->
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          <img src="dist/img/user1-128x128.jpg" class="brand-image img-circle elevation-3" alt="User Image" height="30" width="30">
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <div class="media">
                ...
                <ul class="navbar-nav ml-auto">
                  <li class="nav-item dropdown">
                    <div class="text-center">
                      ...
                      <img src="dist/img/user8-128x128.jpg" alt="User image"  class="img-circle" style="height: 100px; width: 100px;">
                      </p>
                      <p>ALumni</p>
              ...
              <div class="dropdown-divider"></div>
                <div>
                      ...
                      <a href="#" class="btn btn-default btn-flat" style="text-align: right;">Sign Out</a>
                </div>
        </div>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="private_chat.php" class="nav-link">
              <i class="nav-icon fas fa-users"></i>
              <p>
                Private chat
                <i class="right fas fa-angle-left"></i>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="view_news.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="view_event.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="view_placement.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>

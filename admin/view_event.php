...
else
{
  ...
  if (isset($_POST['b1']))
  {
    ...
    { 
      $event_id=$checkbox[$i];
      mysqli_query($cn,"delete from event where event_id='".$event_id."' ");
    }
  ...
  include 'DBController.php';
    ...
    $productResult = $db_handle->runQuery("select * from event");
...
require_once('connection.php');
$result=mysqli_query($cn,"select * from event_detail");
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">View All Event Detail</h3>&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="card-body table-responsive p-3">
              ...
              <table id="example1" class="table table-bordered table-hover  table-head-fixed">
                ...
                <tr>
                  ...
                  <td><a href="delete_event.php?no=<?php echo $data['event_id']; ?>"><i class="fas fa-skull-crossbones"></i></td>
                </tr>
                <?php 
                  }
                ?>

...
else
{
  ...
  if (isset($_POST['b1']))
  {
    ...
    { 
      $g_id=$checkbox[$i];
      mysqli_query($cn,"delete from gallery where g_id='".$g_id."' ");
    }
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">View All Gallary Detail</h3>
            ...
            <div class="card-body table-responsive p-3">
              ...
              <table id="example1" class="table table-bordered table-hover table-head-fixed">
                ...
                <tbody>
                  ...
                  <td><a href="delete_gallary.php?no=<?php echo $data['g_id']; ?>"><i class="fas fa-skull-crossbones"></i></td>
                </tr>

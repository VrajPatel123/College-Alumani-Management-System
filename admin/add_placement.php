...
else
{
  ...
  if(isset($_POST['b1']))
  {
    ...
    $company_description=$_POST['txtcdescription'];
     ...
     // echo "INSERT INTO `job_ad`(`job_name`, `company_name`, `company_logo`, `ad_photo`, `date`, `apply_date`, `expire_date`, `fees`, `description`, `company_address`,`company_description`) VALUES ('$name','$cname','$clogo','$adphoto','$date','$adate','$edate','$fess','$jdescription','$caddress','$company_description')";

    $sql=mysqli_query($cn,"INSERT INTO `job_ad`(`job_name`, `company_name`, `company_logo`, `ad_photo`, `date`, `apply_date`, `expire_date`, `fees`, `description`, `company_address`,`company_description`) VALUES ('$name','$cname','$clogo','$adphoto','$date','$adate','$edate','$fess','$jdescription','$caddress','$company_description')");
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2"style="text-align: right;">
          <div class="col-sm-7">
            <h1>Placemet Detail</h1>
          </div>
          <div class="col-sm-5">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active"> Placement Detail</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
          ...
          <div class="col-md-11">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" name="add_placement" enctype="multipart/form-data" onsubmit="return validation()">
                <div class="card-body">
                  ...
                  <div class="form-group"style="text-align: left">
                    ...
                    <textarea type="textbox" class="form-control" id="txtcaddress"name="txtcaddress" placeholder="Enter Company Venue"></textarea>
...
<script type="text/javascript">
  function validation()
  {
    ...
    if (caddress == '') 
    {
      document.getElementById('caddress').innerHTML = "** Please fill the Company Address field";
      return false;
    }
    if((caddress.length <=20)||(caddress.length >100))
    {
      document.getElementById('caddress').innerHTML = "** Company Address length must be between 20 and 100";
      return false;
    }

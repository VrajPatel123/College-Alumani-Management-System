...
else
{
  ...
  {
    $date=$_POST['txtdate'];
    $news=$_POST['txtheading'];
    $description=$_POST['txtdescription'];
    $photo=$_FILES['txtphoto']['name'];
    $tempname=$_FILES['txtphoto']['tmp_name'];
    move_uploaded_file($tempname, "image/newsimg/$photo");

    mysqli_query($cn,"INSERT INTO `news`(`date_of_news`, `news_heading`, `description`, `photo`) VALUES ('$date','$news','$description','$photo')");
            ...
            <div class="card card-primary">
              ...
              <form role="form" method="post" name="add_staff" enctype="multipart/form-data" onsubmit="return validation()">
                <div class="card-body">
                    ...
                    <input type="date" class="form-control" id="txtdate" name="txtdate" placeholder="Enter News Date">
                    <span id="date" class="text-danger font-weight-bold"> </span>
                  </div>

                  <div class="form-group"style="text-align: left">
                    <label for="exampleInputEmail1">News Heading</label>
                    <input type="text" class="form-control" id="txtheading"name="txtheading" placeholder="Enter News Heading" autocomplete="off">
                    <span id="heading" class="text-danger font-weight-bold"> </span>
                  </div>

                  <div class="form-group"style="text-align: left">
                    <label for="exampleInputEmail1">Description</label>
                    <textarea type="textbox" class="form-control" id="txtdescription"name="txtdescription" placeholder="Enter Description"></textarea>
...
<script type="text/javascript">
  function validation()
  {
    ...
    var heading = document.getElementById('txtheading').value;
    ...
    if (heading == "") 
    {
      document.getElementById('heading').innerHTML = "** Please fill the News Heading field";
      return false;
    }
    if((heading.length <=5)||(heading.length >100))
    {
      document.getElementById('heading').innerHTML = "** SurName length must be between 5 and 100";
      return false;
    }
    
    if (description == '') 
    {
      document.getElementById('description').innerHTML = "** Please fill the Description field";
      return false;
    }

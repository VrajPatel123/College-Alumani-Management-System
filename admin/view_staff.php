...
else
{
  ...
  if (isset($_POST['b1']))
  {
    ...
    { 
      $staff_id=$checkbox[$i];
      mysqli_query($cn,"delete from staff_detail where staff_id='".$staff_id."' ");
    }
  ...
  include 'DBController.php';
    ...
    $productResult = $db_handle->runQuery("select * from staff_detail");
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">View All Staff Detail</h3>
            ...
            <div class="card-body table-responsive p-3">
              ...
              <table id="example1" class="table table-bordered table-hover table-head-fixed">
                ...
                <tr>
                  ...
                  <td><img src="image/staffimg/<?php echo $data['photo'];?>" style="max-height: 150px;max-width: 120px;padding-left: 50px" ></td>
                  ...
                  <td><a href="delete_staff.php?no=<?php echo $data['staff_id']; ?>"><i class="fas fa-skull-crossbones"></i></td>

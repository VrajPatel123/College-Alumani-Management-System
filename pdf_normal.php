                 ...
                 <div class="col-lg-12 col-md-12 ml-auto">
                                            <div class="register-form-wrap">
                                                <div class="mainDetails">
                                                    <div id="headshot">
                                                        <img src="admin/image/normal_biodata/'.$r['photo'].'" alt="Alan Smith" style="width: 100px;height: 100px;"  />
                                                    </div>
                                                            ...
                                                            <div class="sectionContent">
                                                                <table class="">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><label>'. $r[3].'</label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="font-weight: bold;">Gender:</th>
                                                                        <td><label>'. $r[40].'</label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="font-weight: bold;">Address:</th>
                                                                        <td><label>'. $r[5].'</label></td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                        </article>
...
$document->stream("Normal", array("Attachment"=>0));
//1  = Download
//0 = Preview

...
<!-- Mirrored from codeboxr.net/themedemo/unialumni/html/event.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Jan 2020 11:37:35 GMT -->
<head>
    <meta charset="utf-8">
...
<?php
$result=mysqli_query($cn,"select * from event");
?>
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="up-event-thumb">
                                        <img src="admin\image\eventimg\<?php echo $r[2]; ?>" class="img-fluid" alt="Upcoming Event" />
...
<!-- Mirrored from codeboxr.net/themedemo/unialumni/html/event.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Jan 2020 11:37:36 GMT -->
</html>

                ...
                <div class="col-lg-12 col-md-12 ml-auto">
                                            <div class="register-form-wrap">
                                                <div class="mainDetails">
                                                    <div id="headshot">
                                                        <img src="admin/image/resume_biodata/'. $r[2].' " alt="Alan Smith" style="width: 100px;height: 100px;"  />
                                                    </div>
...
$document->stream("Resume", array("Attachment"=>0));
//1  = Download
//0 = Preview

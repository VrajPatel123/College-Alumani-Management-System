...
//$page = file_get_contents("cat_normal.php");
$id=$_SESSION['sid'];
                 ...
                 <div class="col-lg-12 col-md-12 ml-auto">
                                            <div class="register-form-wrap">
                                                <div class="mainDetails">
                                                    <div id="headshot">
                                                        <img src="admin/image/cv_biodata/'. $r[2].'" alt="Alan Smith" style="width: 100px;height: 100px;"  />
                                                    </div>
                                                    ...
                                                    <section>
                                                        <article>
                                                            ...
                                                            <div class="sectionContent">
                                                                <table class="table">
                                                                    <tr>
                                                                        <th style="font-weight: bold;">'. $r[29].'</th>
                                                                        <td><label>'. $r[30].'</label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="font-weight: bold;">'. $r[31].'</th>
                                                                        <td><label>'. $r[32].'</label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="font-weight: bold;">'. $r[33].'</th>
                                                                        <td><label>'. $r[34].'</label></td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                        </article>
...
//$page = file_get_contents("normal_test.php");
...
$document->stream("Curriculum Vitae", array("Attachment"=>0));
//1  = Download
//0 = Preview

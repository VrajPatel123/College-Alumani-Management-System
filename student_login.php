...
if(isset($_POST['b1']))
{
  ...
  $pwd=$_POST['txtpwd'];
    $r=mysqli_fetch_array(mysqli_query($cn,"SELECT count(*),`email`, `pwd`,s_name,s_id FROM `student_profile` WHERE email='$email' and pwd='$pwd'"));
        ...
        if($r[0]==1)
        {
            ...
            //$_SESSION['user_batch']=$r[5];
             echo '<script>';   
            echo 'alert("Email & Password is correct")';  //not showing an alert box.
            echo '</script>';
        ...
        else
        {
            ...
            echo '<script>';
            echo 'alert("Email & Password Doesn`t correct")';  //not showing an alert box.
            echo '</script>';
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="signin-area-wrap">
                                                        ...
                                                        <div class="sign-form">
                                                            <form name="f1" method="POST" enctype="multipart/form-data">
                                                                <input type="email" placeholder="Enter your ID" name="txtemail" />
                                                                <input type="password" placeholder="Password" name="txtpwd" />
                                                                <button type="submit" class="btn btn-reg" name="b1">Login</button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-7 col-md-6 ml-auto">
                                            <div class="register-form-wrap">
                                                <img src="assets/img/committee/commitee-2.jpg" alt="committee"  height="500" width="500" />

...
$r=mysqli_fetch_array(mysqli_query($cn,"select * from bio_resume where s_id=$id order by resume_id desc limit 1 "));
}
?>
<!DOCTYPE html>
                                ...
                                <div class="register-form-content">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 ml-auto">
                                            <div class="register-form-wrap">
                                                <div class="mainDetails">
                                                    <div id="headshot">
                                                        <img src="admin/image/resume_biodata/<?php echo $r[2]; ?>" alt="Alan Smith" style="width: 100px;height: 100px;"  />
                                                    </div>
                                                            ...
                                                            <div class="sectionContent">
                                                                <table class="table">
                                                                    <tr>
                                                                        ...
                                                                        <td><label><?php echo $r[6]; ?></label></td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <th style="font-weight: bold;">Domicile:</th>
                                                                        <td><label><?php echo $r[9]; ?></label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="font-weight: bold;">Cnic Number:</th>
                                                                        <td><label><?php echo $r[12]; ?></label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="font-weight: bold;">Religion:</th>
                                                                        <td><label><?php echo $r[13]; ?></label></td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                        </article>
                                        ...
                                        <form name="f1" method="post" enctype="multipart/form-data">
                                            <button type="button" class="btn btn-reg" onclick="location.href='pdf_resume.php?id=<?php echo $r[0]; ?>' "  >DOWNLOAD PDF</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
